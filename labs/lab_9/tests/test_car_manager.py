import unittest
from lab_9.car_manager.car_manager import Car
...
class TestCar(unittest.TestCase):
    ...
    def test_carInit_withNoneMake_shouldRaise(self):
        make = None
        model = 'test model'
        fuel_consumption = 6
        fuel_capacity = 60
    ...
    def test_carInit_withEmptyStringMake_shouldRaise(self):
        make = ""
        model = 'test model'
        fuel_consumption = 6
        fuel_capacity = 60
    ...
    def test_carInit_withNoneModel_shouldRaise(self):
        make = 'test make'
        model = None
        fuel_consumption = 6
        fuel_capacity = 60
    ...
    def test_carInit_withEmptyStringModel_shouldRaise(self):
        make = 'test make'
        model = ''
        fuel_consumption = 6
        fuel_capacity = 60
