import unittest
from lab_9.list.list import IntegerList
...
class TestIntegerList(unittest.TestCase):
    ...
    def test_integerListRemove_whenIndexIsValid_shouldBeRemoved(self):
    ...
    def test_integerListRemove_whenIndexIsInvalid_shouldRaise(self):
        il = IntegerList(1, 2, 3, 4, 5, 6, 7)
        with self.assertRaises(Exception) as context:
    ...
    def test_integerListGetBiggest_shouldReturnMaxElement(self):
        il = IntegerList(1, 2, 3, 4, 5, 6, 7)
    ...
    def test_integerListGetInsert_whenIndexIsValid_shouldInsertIt(self):
        il = IntegerList(1, 2, 3, 4, 5, 6, 7)
        il.insert(2, -1)
        self.assertListEqual([1, 2, -1, 3, 4, 5, 6, 7], il.get_data())

    def test_integerListInsert_whenIndexIsNotInvalid_shouldRaise(self):
        il = IntegerList(1, 2, 3, 4, 5, 6, 7)
        with self.assertRaises(Exception) as context:
    ...
    def test_integerListInsert_whenValueNotInteger_shouldRaise(self):
        il = IntegerList(1, 2, 3, 4, 5, 6, 7)
        with self.assertRaises(Exception) as context:
            il.insert(0,True)
